...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  G4int z;
    ...
    //ElCu63
     ...
     a=12.0107*g/mole;
     z=6;
     G4Element* elC12 = new G4Element ("Carbon12", "C12", z, a );

     //ElO16
     a=15.9994*g/mole;
     z=8;
     G4Element* elO16 = new G4Element ("Oxygen16", "O16", z, a );
    ...
    //12C                                                                                                                                   
    G4Material*  C12 = new G4Material("C12", 2.267*g/cm3, 1);
    C12 -> AddElement(elC12, 1);

    //16O                                                                                                                                   
    G4Material*  O16 = new G4Material("O16", 0.001429*g/cm3, 1);
    O16 -> AddElement(elO16, 1);
