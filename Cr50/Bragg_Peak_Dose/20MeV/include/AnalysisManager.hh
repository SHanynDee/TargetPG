...
public:
  ...
  void FillVertex(G4double Ekin, G4int FinalA, G4int FinalZ, G4double Step, G4double EkinProton, G4double edepStep, G4double PositionX, G4double PositionY, G4double PositionZ, G4double dose, G4double rmsDose);
