...
void AnalysisManager::CreateNtuples()
{
  ...
  manager -> CreateNtupleDColumn("rmsDose");
  ...
  manager->CreateH2("EprotonvsPosX","Eproton vs PositionX", 1000, 0. , 4., 1000, 0. ,20.);
  manager->CreateH2("EprotonvsPosX_gammagate","Eproton vs PositionX with gamma gate", 1000, 0. , 4., 1000, 0. ,20.);
...
void AnalysisManager::FillVertex(G4double Ekin, G4int FinalA, G4int FinalZ, G4double Step, G4double EkinProton, G4double edepStep, G4double PositionX, G4double PositionY, G4double PositionZ, G4double dose, G4double rmsDose)
{
  G4AnalysisManager* manager = G4AnalysisManager::Instance();
